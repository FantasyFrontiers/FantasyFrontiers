package net.fantasyfrontiers.manager

import net.fantasyfrontiers.annotations.MessageCommand
import net.fantasyfrontiers.annotations.SlashCommand
import net.fantasyfrontiers.annotations.UserCommand
import net.fantasyfrontiers.data.cache.TranslationCache
import net.fantasyfrontiers.interfaces.HasOptions
import net.fantasyfrontiers.interfaces.HasSubcommandGroups
import net.fantasyfrontiers.interfaces.HasSubcommands
import net.fantasyfrontiers.utils.functions.getDiscordLocale
...
object RegisterManager {
    ...
    fun JDABuilder.registerAll() : JDABuilder {
        val reflections = Reflections("net.fantasyfrontiers")
